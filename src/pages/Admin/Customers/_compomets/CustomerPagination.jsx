...
export default function CustomerPagination() {
  return (
    <div className="flex flex-col gap-4 rounded-b-xl border border-t-0 bg-white p-5 sm:flex-row sm:items-center sm:justify-between">
      <p className="text-sm text-gray-600">
        Showing 1 to 10 of 1,248 customers
      </p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button className="h-9 w-9 rounded-lg border">125</button>
