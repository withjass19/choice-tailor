...
export default function EditMeasurementDialog({
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      trouser_waist: profile.trouser_waist || "",
      hip: profile.hip || "",
      thigh: profile.thigh || "",
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Special fitting instructions..."
            />
          </div>
...
function Input({
  ...
  return (
    <div>
      ...
      <input
        type={name === "profile_name" ? "text" : "number"}
        name={name}
        value={value}
        onChange={onChange}
        placeholder={placeholder}
        className="w-full rounded-lg border px-4 py-3 text-sm outline-none transition focus:border-[#b89b3c]"
      />
    </div>
  );
}